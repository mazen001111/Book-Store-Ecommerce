...
return (
    <div className='w-full flex justify-center flex-col items-center gap-10 pt-100 mb-71.5 mt-15'>
        <div className="w-full scale-x-[-1] z-10 overflow-hidden h-95.75 bg-cover bg-top bg-no-repeat absolute top-0 " style={{ backgroundImage: `url(${Library})` }}>
            ...
            <Form className='flex flex-col gap-6 w-xl items-center'>
                <div className='flex flex-row w-full gap-4'>
                    <label className='w-full flex flex-col gap-2' htmlFor="FirstName">
                        ...
                        <Field className="w-full bg-[#FFFFFF] border rounded-lg border-[#22222233] outline-0 h-12 text-[#22222280] text-[16px] font-normal p-4" type="text" name="FirstName" placeholder="John" autoComplete="First Name" />
                    ...
                    <label className='w-full flex flex-col gap-2' htmlFor="LastName">
                        ...
                        <Field className="w-full bg-[#FFFFFF] border rounded-lg border-[#22222233] outline-0 h-12 text-[#22222280] text-[16px] font-normal p-4" type="text" name="LastName" placeholder="Smith" autoComplete="Last Name" />
                ...
                <label className='w-full flex flex-col gap-2' htmlFor="email">
                    ...
                    <Field className="w-full bg-[#FFFFFF] border rounded-lg border-[#22222233] outline-0 h-12 text-[#22222280] text-[16px] font-normal p-4" type="email" name="email" placeholder="example@gmail.com" autoComplete="Email" />
                ...
                <label className='flex flex-row w-full justify-start gap-2 -mt-2 items-center' htmlFor="Remember">
                    ...
                    <p name="Remember" className='text-[#222222] font-openSans font-normal text-[14px]'>Agree with <Link className='cursor-pointer text-[14px] text-[#D9176C] font-medium '>Terms & conditions</Link></p>
                </label>
