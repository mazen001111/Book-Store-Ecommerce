            ...
            <Formik validationSchema={validationSchema} onSubmit={(values) => submit(values)} initialValues={{ email: "", }}>
                <Form className='flex flex-col gap-10 max-w-[90%] w-xl items-center'>
                    <div className='w-full h-fit flex flex-col gap-4'>
                        <h1 className='text-center font-openSans font-semibold text-[#D9176C]'>Forget Password?</h1>
                        <p className='text-center text-[#22222280] w-full text-[14px]'>Enter your email to reset your password</p>
                    </div>
                    ...
                    <button type='submit' className='bg-[#D9176C] w-full h-12 rounded-lg cursor-pointer text-lg text-[#FFFFFF]' >Send reset code</button>
                </Form>
            </Formik>
