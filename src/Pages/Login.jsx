            ...
            <Formik validationSchema={validationSchema} onSubmit={(values) => submit(values)} initialValues={{ identifier: "", password: "", Remember: false }}>
                <Form className='flex flex-col gap-6 w-xl items-center'>
                    ...
                    <label className='w-full flex flex-col gap-2' htmlFor="email">
                        ...
                        <Field className="w-full bg-[#FFFFFF] border rounded-lg border-[#22222233] outline-0 h-12 text-[#22222280] text-[16px] font-normal p-4" type="text" name="identifier" placeholder="example@gmail.com" />
                        <ErrorMessage name='identifier' component={"p"} className='text-error' />
                    </label>
                    <label className='w-full flex flex-col gap-2' htmlFor="password">
                        ...
                        <Field className="w-full bg-[#FFFFFF] border rounded-lg border-[#22222233] outline-0 h-12 text-[#22222280] text-[16px] font-normal p-4" type="text" name="password" placeholder="Enter password" />
                    ...
                    <button type='submit' className='bg-[#D9176C] w-full h-12 rounded-lg cursor-pointer text-lg ' >Log in</button>
                </Form>
            </Formik>
            <div>
